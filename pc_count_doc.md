# Workflow
## Getting Employee PC Count

> Computer description may make identification more obvious, but a PC may have been given to another person. Steps below are for verifying a PC's status with higher confidence. 

> LogMeIn Inventory may not identify the user outright, but these steps will help narrow down who to contact for confirmation on a given PC's status.

- Assign Identity to a PC with these steps:
1. Check last login user for assigning a PC.
